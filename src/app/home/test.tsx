...
export function Test() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 mb-4 p-4">
      <Dock magnification={80} distance={200} >
        <DockIcon size={60} className="bg-black/10 dark:bg-white/10 p-3" onClick= {()=> 
          router.push('/upload')}>
            <Link href='/upload'>
        ...
        <DockIcon size={60} className="bg-black/10 dark:bg-white/10 p-3"onClick= {()=> {
          router.push('/upload')
             ...
             <Link href='/vibers'>
             <Icons.lastone className="size-full" />
             </Link>
